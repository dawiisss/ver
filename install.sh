...
${COLOR_BOLD}OPTIONS:${COLOR_RESET}
    ...
    ${COLOR_CYAN}-v, --version <TAG>${COLOR_RESET}    Install a specific release version (e.g. 'v1.4.0' or '1.4.0')
...
${COLOR_BOLD}ENVIRONMENT VARIABLES:${COLOR_RESET}
    ${COLOR_CYAN}VERSION${COLOR_RESET}                Target release version to download (e.g. VERSION=v1.4.0)
